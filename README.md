...
<ul>
  ...
  <li>Lazy-loads images only when necessary using the <a target='_blank' href='https://www.npmjs.com/package/react-intersection-observer'>React Intersection Observer</a></li>

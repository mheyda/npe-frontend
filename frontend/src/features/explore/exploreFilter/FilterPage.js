...
export default function FilterPage({ setFiltersOpen }) {
    ...
    const stateOptions = [
        ...
        { title: 'Louisiana', value: 'LA' }, { title: 'Maine', value: 'ME' }, { title: 'Maryland', value: 'MD' }, { title: 'Massachusettes', value: 'MA' }, { title: 'Michigan', value: 'MI' }, { title: 'Minnesota', value: 'MN' }, { title: 'Northern Mariana Islands', value: 'MP'}, { title: 'Mississippi', value: 'MS' }, { title: 'Missouri', value: 'MO' }, { title: 'Montana', value: 'MT' }, { title: 'Nebraska', value: 'NE' }, 
            ...
            <div className='filter-page'>
                ...
                ?   <> 
                        <p className='filter-page-subheading'>
                            Sort by
                            {sort !== 'Alphabetical (A-Z)' ? <button className='clear-sort-btn' onClick={clearSort}>Clear</button> : <></>}
                        </p>
                        <Select name={''} options={sortOptions} onChange={updateSort} clearSort={clearSort} />
                    </> 
                : <></>}
                <p className='filter-page-subheading'>Filter by</p>
                <FilterSelector name={'Park Designation'} filterTitle={'designations'} options={designationOptions} handleChange={updateDesignations} />
                <FilterSelector name={'State & Territory'} filterTitle={'stateCodes'} options={stateOptions} handleChange={updateStateCodes} />
                {view === 'list'
